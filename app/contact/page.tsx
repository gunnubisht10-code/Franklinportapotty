...
// NOTE: Since we must use 'use client' for the form, metadata must be defined statically.
// export const metadata: Metadata = { ... } // Won't work in client component.
// Instead, Metadata is handled by the root layout. For a specific title, you'd manage it with state/effects if needed.
